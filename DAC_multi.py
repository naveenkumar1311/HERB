...
#Multiplicative increase sliding window
...
while len(total_task_buffer)>0 or len(global_task_buffer) > 0:
        ...
        if (len(global_task_buffer)<global_buffer_size):
                ...
                if (len(new_dropped_tasks)>=threshold_packet_drop):
                        # window_length = initial_window_length
                ...
                print(threshold_packet_drop,len(new_dropped_tasks),window_length)
                ...
                if len(global_task_buffer)>=window_length:
                        ...
                        new_dropped_tasks = dropped_tasks
                        ###print  "gtb"
...
#     csvwriter.writerow([filename[13:],f2,'Multiplicative',global_buffer_size,initial_window_length,time,sum(avg_turnaround_time)/len(avg_turnaround_time),sum(avg_waiting_time)/len(avg_waiting_time),sum(percent_execution)/len(percent_execution),queue]) 