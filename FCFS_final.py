...
filename = sys.argv[1]
# filename = 'testcase1_tasks100.txt'
...
awt = (sum(avg_waiting_time)/len(avg_waiting_time))
# #print  "AWT....list...", avg_waiting_time
...
print "\nSJF results......."
print  tabulate([['Dynamic SJF',filename,sum(avg_turnaround_time)/len(avg_turnaround_time),awt,time,(sum(percent_execution)/len(percent_execution)) - value1]],headers=['Alg ', 'Ttcse', 'AvgTAT', 'AvgWT','#Tstmps', '% exec'], tablefmt='orgtbl')